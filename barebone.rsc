...
/ip address add address=192.168.77.1/24 comment="Admin port IP address" interface=ether10 network=192.168.77.0
/ip dhcp-server add address-pool=admin-pool interface=ether10 lease-time=1d name=admin-dhcp
